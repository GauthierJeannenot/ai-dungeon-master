...
- `adventures/<id>/player-rules.md` — Règles côté joueur *(optionnel : repli sur `adventures/_shared/`)*
- `adventures/<id>/dm-rules.md` — Tables de monstres, règles de combat *(optionnel : repli sur `adventures/_shared/`)*

Les règles D&D génériques de repli vivent dans `adventures/_shared/`
(player-rules.md + dm-rules.md avec le bestiaire générique des types moteur) —
sans aucun vocabulaire de module.
